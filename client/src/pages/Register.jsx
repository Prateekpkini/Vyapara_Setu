...
const handleRegister = async () => {
  ...
  try {
    ...
    const categories =
      type === "vendor" ? CATEGORIES_VENDOR : CATEGORIES_KIRANA;
    ...
    <div className='reg-page'>
      ...
      {step < 4 && (
        <div className='reg-stepper'>
          {['Account Type', 'Business Info', 'DigiLocker Verify'].map(
            (label, i) => (
              <React.Fragment key={i}>
                ...
                {i < 2 && (
                  <div
                    className={`reg-step-line ${step > i + 1 ? 'done' : ''}`}
                  />
                )}
              </React.Fragment>
            ),
      ...
      <div className='reg-main'>
            ...
            <div className='type-grid'>
              <div
                ...
                <p className='type-card-desc'>
                  I supply goods to kirana stores and want to manage credit risk
                </p>
                {type === 'vendor' && (
                  <div className='type-selected-badge'>✓ Selected</div>
                )}
              </div>
              <div
                ...
                <p className='type-card-desc'>
                  I run a retail store and want to build my credit profile
                </p>
                {type === 'kirana' && (
                  <div className='type-selected-badge'>✓ Selected</div>
                )}
        ...
        {step === 2 && (
          <div className='reg-section'>
            ...
            <p className='reg-sub'>
              We use this to create your TradeScore profile
            </p>
...
Must include uppercase, lowercase, number & special character
        ...
        {step === 3 && (
          <div className='reg-section'>
            ...
            <p className='reg-sub'>
              Verify your identity via DigiLocker to boost your TradeScore by up
              to +120 points. Your Aadhaar-linked documents are fetched securely
            ...
            <div className='digilocker-banner'>
              <div className='digilocker-logo'>
                ...
                <div>
                  ...
                  <div className='digilocker-sub'>
                    Secure document verification via MeitY's official platform
                  </div>
                </div>
              </div>
              ...
              <>
                <div
                  ...
                  <div
                    ...
                    Your Aadhaar is used only for OTP-based DigiLocker
                    authentication
                  </div>
                </div>
                  ...
                  <>
                    ...
                    <div className='form-group'>
                      ...
                      <input
                        ...
                        value={digiOtp}
                        onChange={(e) =>
                          setDigiOtp(e.target.value.replace(/\D/g, ''))
                        }
                      />
                    </div>
                    <button
                      ...
                      disabled={digiStatus === 'verifying'}>
                      {digiStatus === 'verifying'
                        ? 'Verifying…'
                        : 'Verify OTP →'}
                    </button>
                  </>
            ...
            <div
              ...
              <label
                ...
                I agree to VyaparSetu's Terms of Service and Privacy Policy. My
                data will be used only for credit scoring and will never be sold
                to third parties.
              </label>
            </div>

            <div
              className='reg-btn-row'
              style={{ marginTop: '1.5rem' }}>
              <button
                className='reg-btn-back'
                onClick={() => goToStep(2)}>
        ...
        {step === 4 && successData && (
          <div className='reg-success'>
            ...
            <div className='success-title'>
              You're in, {successData.name?.split(' ')[0] || 'Welcome'}!
            </div>
            <p
              style={{
                color: 'var(--text)',
              ...
              Your TradeScore profile is being generated. Here's your initial
              credit assessment:
            </p>
            <div className='success-score-card'>
              ...
              <div
                ...
                {digiStatus === 'success'
                  ? 'DigiLocker verified · +120 pts applied'
                  : 'Upload more documents to improve your score'}
              </div>
            </div>
            <button
              className='reg-btn-next'
